...
package com.longtv.nwstagfinder;
...
public class ModelBase {
    ...
    private static class ModelTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (D)
                Log.i(getClass().getName(), String.format("Time taken (ms): %d %.2f", finishTime.getTime() - mModel.mTaskStartTime.getTime(), mModel.mLastTaskExecutionDuration));
        }
    }
